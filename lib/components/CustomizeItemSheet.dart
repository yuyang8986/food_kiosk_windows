    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          FittedBox(
            fit: BoxFit.fitWidth,
            child: Text(widget.item.getName(), style: TextStyle(fontWeight: FontWeight.bold)),
          ),
          SizedBox(height: 50),
          Text("Customize", style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
          ListTile(
            title: Text("Quantity"),
            trailing: Row(
              mainAxisSize: MainAxisSize.min,
              children: [
                IconButton(
                  ...
                  onPressed: () => setState(() => widget.item.quantity = max(1, widget.item.quantity - 1)),
                ),
          ...
          ListTile(
            ...
            trailing: DropdownButton<int>(
              ...
              onChanged: (newValue) => setState(() => widget.item.sugarLevel = newValue!),
            ),
          ),
          ...{
            "Cookie": 11.0,
